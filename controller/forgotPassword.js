    ...
    try {
        ...
        if (user) {
            ...
            const data = await tranEmailApi.sendTransacEmail({
                ...
                htmlContent: `<p>Expense Tracker -Please click on the link sent, to reset your password.</p><a href="http://18.207.35.90:3000/password/resetPassword/${id}">Reset Password</a>`
            })
            await t.commit()
        ...
        if (forgotPass.isActive) {
            ...
            async function updatePassword(e)
            {
                try{
                    ...
                    const data=await axios.post('http://18.207.35.90:3000/password/updatePassword/${forgotId}',obj)
                    console.log(data)
